  ...
  "songs": [
    {
      ...
      "thumbnail": "https://img.youtube.com/vi/OsU0CGWaLXw/maxresdefault.jpg",
      "key_lyrics": [
    ...
    },
    {
      ...
      "thumbnail": "https://img.youtube.com/vi/VAdGW7QDJiU/maxresdefault.jpg",
      "key_lyrics": [
    ...
    },
    {
      ...
      "thumbnail": "https://img.youtube.com/vi/IktZNVqO1EY/maxresdefault.jpg",
      "key_lyrics": [
...
function buildSongCard(song, index) {
  ...
  return `
    <a href="${url}" class="song-card animate" style="animation-delay: ${animDelay}; opacity: 0;">
      ...
      <img src="${song.thumbnail}" alt="${song.title} Thumbnail" class="song-thumb" loading="lazy">
      <div class="song-info">
  ...
  if (adminV2Form) {
    adminV2Form.addEventListener('submit', (e) => {
      ...
      const newSong = {
        ...
        youtube_link: formattedEmbed, thumbnail,
